...
export const RateDetailsView = ({ offer, discount, hasSolar, vpp, units = {}, isVppPlan, className, planRatesJson, isDnspBased, selectedDnsp, showDiscountIndicator = false }: RateDetailsViewProps) => {
    ...
    const energyRatesItems = processItems([
        { label: 'Peak', value: offer.peak, type: 'peak', applyDiscount: false },
        { label: 'Off-Peak', value: offer.offPeak, type: 'offPeak', applyDiscount: false },
        { label: 'Shoulder', value: offer.shoulder, type: 'shoulder', applyDiscount: false },
        { label: 'Anytime', value: offer.anytime, type: 'anytime', applyDiscount: false },
    ...
    const supplyChargesItems = processItems([
        { label: 'Supply Charge', value: offer.supplyCharge, type: 'supplyCharge', applyDiscount: false },
    ...
    const demandChargesItems = processItems([
        { label: 'Demand', value: offer.demand, type: 'demand', applyDiscount: false },
        { label: 'Demand(Op)', value: offer.demandOp, type: 'demandOp', applyDiscount: false },
        { label: 'Demand(P)', value: offer.demandP, type: 'demandP', applyDiscount: false },
        { label: 'Demand(S)', value: offer.demandS, type: 'demandS', applyDiscount: false },
    ...
    const rawSolarFitItems = !hasFiTFlag || !hasSolar ? [] : [
        { label: 'Feed-in Tariff', value: offer.fit, type: 'fit', applyDiscount: false },
        { label: 'PREMIUM FIT', value: offer.fitPeak, type: 'fitPeak', applyDiscount: false },
        { label: 'CRITICAL EVENT FIT', value: offer.fitCritical, type: 'fitCritical', applyDiscount: false },
        { label: 'BASE FIT', value: offer.fitVpp, type: 'fitVpp', applyDiscount: false },
    ...
    const controlledLoadItems = processItems(!hasCLFlag ? [] : [
        { label: 'CL1 Usage', value: offer.cl1Usage, type: 'cl1_usage', applyDiscount: false },
        { label: 'CL2 Usage', value: offer.cl2Usage, type: 'cl2_usage', applyDiscount: false },
        { label: 'CL1 Supply', value: offer.cl1Supply, type: 'cl1_supply', applyDiscount: false },
        { label: 'CL2 Supply', value: offer.cl2Supply, type: 'cl2_supply', applyDiscount: false },
    ...
    const fitRates = processItems(remainingDynamicRates
        ...
        .map((r: any) => ({ label: r.name, name: r.name, value: r.value, type: 'dynamic', unitId: r.unitId, applyDiscount: false, description: r.description || r.info })), 'extra_fit');
    const chargeRates = processItems(remainingDynamicRates
        ...
        .map((r: any) => ({ label: r.name, name: r.name, value: r.value, type: 'dynamic', unitId: r.unitId, applyDiscount: false, description: r.description || r.info })), 'extra_charges');
            ...
            <div className="space-y-2 min-w-[180px] flex-1">
                ...
                <div className="space-y-2">
                    {rates.map((dRate: any, id: number) => {
                        ...
                        const shouldApplyDiscount = dRate.applyDiscount === true;
                        const price = shouldApplyDiscount ? calculateDiscountedRate(val, discount) : val;
                        return (
                    ...
                    <div className="space-y-2 min-w-[180px] flex-1">
                        ...
                        {[...energyRatesItems]
                            ...
                            .map((rate, idx) => {
                                ...
                                const numericValue = parseFloat(String(rate.value || 0));
                                const shouldApplyDiscount = rate.applyDiscount === true;
                        ...
                        {supplyChargesItems.length > 0 && (
                            <div className="space-y-2">
                                ...
                                {supplyChargesItems.map((r: any, id: number) => {
                                    ...
                                    const shouldApplyDiscount = r.applyDiscount === true;
                                    const price = shouldApplyDiscount ? calculateDiscountedRate(numericValue, discount) : numericValue;
                                    return (
                        ...
                        {demandChargesItems.length > 0 && (
                            <div className="space-y-2 pt-2">
                                ...
                                {demandChargesItems.map((d: any, id: number) => {
                                    ...
                                    const shouldApplyDiscount = d.applyDiscount === true;
                                    const price = shouldApplyDiscount ? calculateDiscountedRate(numericValue, discount) : numericValue;
                                    return (
