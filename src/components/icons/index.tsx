...
export const UsersIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const InfoIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const UploadIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const ArrowRightIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const ArrowLeftIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const MoreHorizontalIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const DocumentTypeIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const NoteTypeIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const NotificationIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const TrendingUpIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const TagIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const StarIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
...
export const AndroidIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={cn(className)} {...props}>
        <path d="M17.523 15.3414c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4482.9993.9993s-.4482.9997-.9993.9997zm-11.046 0c-.5511 0-.9993-.4486-.9993-.9997s.4482-.9993.9993-.9993c.5511 0 .9993.4482.9993.9993s-.4482.9997-.9993.9997zm11.4045-7.284l1.9342-3.3496c.1594-.2765.0645-.6306-.2125-.7893-.2762-.1594-.6306-.0649-.7898.2125l-1.9665 3.4057A11.7588 11.7588 0 0012 6.3263c-2.128 0-4.1228.5668-5.8468 1.5367L4.1866 4.4573c-.159-.2776-.5136-.372-.7898-.2125-.2772.1586-.3715.5127-.2125.7893l1.9346 3.3496C2.2618 10.0215.3986 13.0456.0505 16.5912h23.899c-.3482-3.5456-2.2114-6.5697-5.068-8.5338z" />
    </svg>
);

export const AppleIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={cn(className)} {...props}>
        <path d="M16.327 10.639c-.019-2.585 2.115-3.829 2.211-3.892-1.203-1.758-3.076-1.996-3.738-2.019-1.583-.161-3.09.932-3.897.932-.806 0-2.05-1.077-3.355-.913-1.691.139-3.255.98-4.135 2.508-1.782 3.084-.456 7.643 1.285 10.155.852 1.233 1.865 2.613 3.197 2.563 1.282-.049 1.776-.827 3.328-.827 1.547 0 2.007.827 3.344.797 1.375-.027 2.247-1.261 3.093-2.496 1.002-1.464 1.414-2.885 1.434-2.958-.029-.013-2.75-1.054-2.766-4.179zm-1.89-6.495c.704-.852 1.178-2.036 1.05-3.219-1.018.041-2.253.676-2.983 1.523-.58.601-1.144 1.815-1.001 2.972 1.14.088 2.23-.563 2.934-1.276z" />
    </svg>
);

export const KeyIcon = ({ size = 18, className, ...props }: IconProps) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={size}
        height={size}
