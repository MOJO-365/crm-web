...
export const DocumentTypesPage = () => {
    ...
    const { data, loading, error, refetch } = useQuery(GET_DOCUMENT_TYPES, {
    ...
    if (error) return <div className="p-8 text-red-500">Error loading document types</div>;
        ...
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage types of documents uploaded by customers</p>
                </div>
                {canCreate && (
