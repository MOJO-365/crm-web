...
const BulkEmailModal: React.FC<BulkEmailModalProps> = ({ isOpen, onClose, selectedCustomerIds, onSuccess }) => {
    ...
    const processedBody = useMemo(() => {
        ...
        body = body.replace(/<img[^>]*src=["']\/gee-energy-logo\.svg["'][^>]*>/gi, '<img src="https://go.gsync.com.au/main-logo-dark%206.png" alt="GEE Energy" style="height:48px; max-height:48px; width:auto; display:block; border:0; margin:0;">');
        body = body.replace(/<img[^>]*src=["']https:\/\/gee\.com\.au\/images\/GEE(?:%20|\s)+Energy(?:%20|\s)+Logo\.svg["'][^>]*>/gi, '<img src="https://go.gsync.com.au/main-logo-dark%206.png" alt="GEE Energy" style="height:48px; max-height:48px; width:auto; display:block; border:0; margin:0;">');
        return body;
